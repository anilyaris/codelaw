pipelines = {
    ...
    "pull_requests": [ {"$project": {"id": 1, "number": 1, "state": 1, "locked": 1, "title": 1, "body": 1, "created_at": 1, "updated_at": 1, "closed_at": 1, "merged_at": 1, "merge_commit_sha": 1, "assignee.login": 1, "assignee.id": 1, "milestone": 1, "merged": 1, "merged_by.id": 1, "merged_by.login": 1} }],
